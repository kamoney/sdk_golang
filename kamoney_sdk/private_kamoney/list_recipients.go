...
func (s *privateRequests) ListRecipients(in kamoney_sdk_dtos.ListRecipientsRequestParams) (out kamoney_sdk_dtos.ListRecipientsRequestResponse, err error) {
	in.Nonce = fmt.Sprint(utility.GenNonce())

	req, err := s.r.RequestHandler("GET", ENDPOINT_ACCOUNT_RECIPIENTS, in)
	if err != nil {
