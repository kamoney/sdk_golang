...
func (s *privateRequests) ListOrderReceipt(in kamoney_sdk_dtos.ListOrderReceiptRequestParams) (out kamoney_sdk_dtos.ListOrderReceiptRequestResponse, err error) {
