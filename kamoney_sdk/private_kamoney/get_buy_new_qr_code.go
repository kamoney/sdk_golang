...
func (s *privateRequests) GetBuyNewQRCode(in kamoney_sdk_dtos.GetBuyNewQRCodeRequestParams, id string) (out kamoney_sdk_dtos.GetBuyNewQRCodeRequestResponse, err error) {
